    ...
    <div>
      ...
      <main>
        <div className={`text-center ${styles.coverManifiesto} ${styles.content}`}>
          ...
          <div>
            <img src="/images/marcha2.png"></img>
          </div>
        </div>
        <div className={styles.manifiesto}>
          <h1>Manifiesto</h1>
          <p>
            El proyecto Una Feminista se crea el 19 de Agosto de 2013 como una propuesta web de difusión de contenido feminista, 
            el objetivo del proyecto es informar sobre el movimiento y abrir espacios de discusión al respecto.
          </p>
          <p>
            Buscamos ser un medio de difusión de noticias y voces feministas, el crear nuestro propio medio  digital es una forma 
            de sumar resistencia al movimiento, dar eco a otras mujeres y romper las barreras patriarcales  y machistas que nos han 
            silenciado por años, va por las que fueron, las que nos arrebataron, las que resistimos y las que vienen, no estamos solas, 
            estamos todas.
          </p>
          <p>
            Que donde una voz misógina dijo que los lugares de creación feminista no son posibles puedan replicar las voces de las 
            mujeres rompiendo esas estructuras y llenando todo de sororidad.
          </p>
          <p>
            Este proyecto pretende fomentar la creación de espacios para crecer colectivamente, que donde el odio a las mujeres 
            irrumpió, la luz feminista deslumbre con nuevas formas de revolución y acompañamiento.
          </p>
          <p>
            Las morras hacemos revolución, somos las hijas rebeldes y contestonas que un día les dijeron “Tú te callas” pero no 
            nos callaron, nos hicieron replicar más fuerte.
          </p>
